  ...
  <div id="app">
    <section class="todo-wrapper">
      ...
      <form @keydown.enter.prevent="">
        <input type="text" class="input-todo" v-bind:class="{ active: new_todo }" placeholder="Title" v-model="new_todo" v-on:keyup.enter="addItem">
        <input type="text" class="input-todo" v-bind:class="{ active: new_todo }" placeholder="Take the garbage out" v-model="new_todo2" v-on:keyup.enter="addItem">
      ...
      <transition name="slide-fade">
        <p class="status free" v-if="!pending.length" ><img src="https://nourabusoud.github.io/vue-todo-list/images/beer_celebration.svg" alt="celebration">Time to move!  You have no secure passwords!</p> 
      </transition> 
    ...
    addItem() {
      ...
      if (this.new_todo) {
        this.todoList.unshift({
          ...
          title:"Title: " + this.new_todo + " " +"Password: "+this.new_todo2,
          done: false,
        });
      }
      // reset new_todo
